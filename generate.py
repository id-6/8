...
async def generate_session(bot, msg, telethon=False):
    await msg.reply(
        "**- استخـراج كـود {} بواسطـة 𝗿𝘂𝗻𝘁𝗵𝗼𝗻 جـارٍ...**".format(
